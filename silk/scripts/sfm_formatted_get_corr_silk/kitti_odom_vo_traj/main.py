...
def main():
    ...
    for sample in tqdm(framework): #2790 files to test
        ...
        # print(intrinsic)
        # tensor([[239.9265,   0.0000, 204.2293],
        # [  0.0000, 244.6153,  63.3463],
    ...
    np.save('/data/ISAP_data_fig_table/ours_pred_10_sfm_depth_corr.npy', pred_array)
    np.save('/data/ISAP_data_fig_table/ours_gt_10_sfm_depth_corr.npy', gt_array)
