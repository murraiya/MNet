...
# )
CHECKPOINT_PATH = os.path.join(
    os.path.dirname(__file__), "../../../lightning_logs/pose_supervised_v0_deafault/checkpoints/epoch=99-step=99999.ckpt"
)
# /root/silk/lightning_logs/formatted_kitti_odom_default_setting/checkpoints/epoch=95-step=95999.ckpt
DEVICE = "cuda:1"
...
SILK_MATCHER = matcher(postprocessing="ratio-test", threshold=0.2)
