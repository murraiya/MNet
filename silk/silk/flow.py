...
class Flow:
    ...
    def define_transition(
        ...
        **kwargs,
        ...
        # print("in define transition ", type(args), type(kwargs))
        # #                                tuple,      dict
        # print("in define transition ", args )
        #                                tuple,      dict
    ...
    def flow_from_tape(self, tape, output_indexes, inputs):
        ...
        for index, to_clean in tape:
            ...
            for i in to_clean:
                session[i] = None
        # print("in flow_from_tape() input len: ", len(inputs))
    ...
    def flow(self, outputs, *inputs_args, **inputs_kwargs):
        ...
        # print("in def flow() input len) ", len(inputs)) #input length 1, collections.OrderedDict
    ...
    def with_outputs(self, outputs):
        # print("in flow.py here makes flow from outputs")
        return FixedOutputFlow(self, outputs)

    def tape_as_pseudocode(self, tape):
        # print("in flow.py tape as pseudocode: ")
...
class FixedOutputFlow:
    def __init__(self, flow, outputs: Union[str, Tuple[str]]) -> None:
        # print("in flow.py FixedOutputFlow __init__")
        self._flow = flow
...
class AutoForward:
    ...
    def forward_flow(self, outputs: Union[str, Tuple[str]], *args, **kwargs):
        # print("in flow.py forward flow: ")

        return self._flow(outputs, *args, **kwargs)

    def forward(self, *args, **kwargs):
        # print("in flow.py forward: ")
